...
bool Eliptic::intersectLocal(const ray& r, isect& i) const
{
	vec3f dir = r.getDirection();
	vec3f ori = r.getPosition();
	double a = dir[0] * dir[0]/16 + dir[1] * dir[1] + dir[2] * dir[2];
	double b = 2 * dir[0] * ori[0]/16 + 2 * dir[2] * ori[2] + 2 * dir[1] * ori[1];
	double c = ori[0] * ori[0]/16 + ori[1] * ori[1] + ori[2] * ori[2] - 1;
